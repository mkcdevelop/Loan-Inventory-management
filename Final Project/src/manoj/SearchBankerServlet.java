...
@WebServlet("/SearchBankerServlet")
public class SearchBankerServlet extends HttpServlet {
	
    public SearchBankerServlet() {
        }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(username!=""&&username!=null){
			...
			while(rs.next()){
				...
				request.getRequestDispatcher("/DeleteBanker.jsp").forward(request, response);
			}
			}
			...
			String err="No such Banker with this username!! try Again!!";
